...
if($result==1){
    ...
    echo "<script>alert('يرجى ادخال جميع الحقول')</script>";
}
...
if (isset($_POST['vecsub'])){
$data = array (
    'type' => $_POST['type'],
    'typeofpest' => $_POST['typeofpest'],
    'firstname' => $_POST['firstname'],
    'phonenumber' => $_POST['phonenumber'],
    'region' => $_POST['region'],
    'buildingnumber' => $_POST ['buildingnumber']
);
$table_name ='diseasevectorform';
...
//-----------------------------------------------------------//
//-------------- Materialstobedestroyed Form------------------//

if (isset($_POST['dessub'])){
$data = array (
    'type' => $_POST['type'],
    'thepurposeofthedamage' => $_POST['thepurposeofthedamage'],
    'firstname' => $_POST['firstname'],
    'phonenumber' => $_POST['phonenumber'],
    'region' => $_POST['region'],
    'details' => $_POST ['details']
);
$table_name ='MaterialstobedestroyedFORM';
