 ...
 */
add_filter( 'woocommerce_add_to_cart_fragments', 'trydo_woocommerce_header_add_to_cart_fragment' );
function trydo_woocommerce_header_add_to_cart_fragment( $fragments ) {
    global $woocommerce;
    ob_start();
    ?>
